...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    List<Tweet> tweets = [
      ...
      Tweet(username: "麦らァ", title: "residentEvil4", url: "https://1.bp.blogspot.com/-tVeC6En4e_E/X96mhDTzJNI/AAAAAAABdBo/jlD_jvZvMuk3qUcNjA_XORrA4w3lhPkdQCNcBGAsYHQ/s1048/onepiece01_luffy.png", clip: false, text: "アシュリーかわいすぎワロタ", ),
